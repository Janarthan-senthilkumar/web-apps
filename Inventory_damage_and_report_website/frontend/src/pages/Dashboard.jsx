...
import { HiOutlineCube, HiOutlineExclamationCircle, HiOutlineRefresh, HiOutlineCurrencyDollar } from 'react-icons/hi';
        ...
        <div className="fade-in">
            <div className="page-header">
                <div>
                    ...
                    <p className="page-subtitle">Overview of inventory, damages, and replacements</p>
                </div>
            </div>
                    ...
                    <div className="section-body">
                        <div className="status-bars">
                            <div className="status-bar-item">
                                ...
                                <div className="status-bar-track">
                                    <div
                                        ...
                                        style={{ width: `${(stats.statusDistribution.pending / maxStatus) * 100}%` }}
                                    />
                                </div>
                            ...
                            <div className="status-bar-item">
                                ...
                                <div className="status-bar-track">
                                    <div
                                        ...
                                        style={{ width: `${(stats.statusDistribution.approved / maxStatus) * 100}%` }}
                                    />
                                </div>
                            ...
                            <div className="status-bar-item">
                                ...
                                <div className="status-bar-track">
                                    <div
                                        className="status-bar-fill replaced"
                                        style={{ width: `${(stats.statusDistribution.replaced / maxStatus) * 100}%` }}
                                    />
                                </div>
